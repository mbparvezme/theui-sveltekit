    ...
    editor = new Editor({
      ...
      extensions: [
        ...
        Placeholder.configure({
          placeholder: $$restProps?.placeholder ?? "Write something …"
        }),
        Typography,
        Youtube.configure({
          ccLanguage: "en",
    ...
    <div class="flex flex-wrap editor-toolbar gap-1">
      <Dropdown animation="fade" align="start">
        ...
        <div class="flex flex-col">
          ...
          <button tabindex="0" type="button" class={dropdownCls} on:click={() => editor.chain().focus().toggleHeading({ level: 3}).run()} class:active={editor.isActive("heading",{level:3})}>Heading 3</button>
          <button tabindex="0" type="button" class={dropdownCls} on:click={() => editor.chain().focus().toggleHeading({ level: 4}).run()} class:active={editor.isActive("heading",{level:4})}>Heading 4</button>
          <button tabindex="0" type="button" class={dropdownCls} on:click={() => editor.chain().focus().toggleHeading({ level: 5}).run()} class:active={editor.isActive("heading",{level:5})}>Heading 5</button>
          <button tabindex="0" type="button" class={dropdownCls} on:click={() => editor.chain().focus().toggleHeading({ level: 6}).run()} class:active={editor.isActive("heading",{level:6})}>Heading 6</button>
        </div>
      </Dropdown>
      <div class="editor-btn-group {containerClass}">
        <button tabindex="0" type="button" class={btnClass()} on:click={() => editor.chain().focus().toggleBold().run()} class:active={editor.isActive("bold")}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="M8.21 13c2.106 0 3.412-1.087 3.412-2.823 0-1.306-.984-2.283-2.324-2.386v-.055a2.176 2.176 0 0 0 1.852-2.14c0-1.51-1.162-2.46-3.014-2.46H3.843V13H8.21zM5.908 4.674h1.696c.963 0 1.517.451 1.517 1.244 0 .834-.629 1.32-1.73 1.32H5.908V4.673zm0 6.788V8.598h1.73c1.217 0 1.88.492 1.88 1.415 0 .943-.643 1.449-1.832 1.449H5.907z"/></svg></button>
        <button tabindex="0" type="button" class={btnClass()} on:click={() => editor.chain().focus().toggleItalic().run()} class:active={editor.isActive("italic")}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="M7.991 11.674 9.53 4.455c.123-.595.246-.71 1.347-.807l.11-.52H7.211l-.11.52c1.06.096 1.128.212 1.005.807L6.57 11.674c-.123.595-.246.71-1.346.806l-.11.52h3.774l.11-.52c-1.06-.095-1.129-.211-1.006-.806z"/></svg></button>
        <button tabindex="0" type="button" class={btnClass()} on:click={() => editor.chain().focus().toggleUnderline().run()} class:active={editor.isActive("underline") ? "is-active" : ""}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="M5.313 3.136h-1.23V9.54c0 2.105 1.47 3.623 3.917 3.623s3.917-1.518 3.917-3.623V3.136h-1.23v6.323c0 1.49-.978 2.57-2.687 2.57-1.709 0-2.687-1.08-2.687-2.57V3.136zM12.5 15h-9v-1h9v1z"/></svg></button>
        {#if includeTools()}
        <button tabindex="0" type="button" class={btnClass()} on:click={() => editor.chain().focus().toggleStrike().run()} class:active={editor.isActive("strike") ? "is-active" : ""}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="M6.333 5.686c0 .31.083.581.27.814H5.166a2.776 2.776 0 0 1-.099-.76c0-1.627 1.436-2.768 3.48-2.768 1.969 0 3.39 1.175 3.445 2.85h-1.23c-.11-1.08-.964-1.743-2.25-1.743-1.23 0-2.18.602-2.18 1.607zm2.194 7.478c-2.153 0-3.589-1.107-3.705-2.81h1.23c.144 1.06 1.129 1.703 2.544 1.703 1.34 0 2.31-.705 2.31-1.675 0-.827-.547-1.374-1.914-1.675L8.046 8.5H1v-1h14v1h-3.504c.468.437.675.994.675 1.697 0 1.826-1.436 2.967-3.644 2.967z"/></svg></button>
        <button tabindex="0" type="button" class={btnClass()} on:click={() => editor.chain().focus().toggleSuperscript().run()} class:active={editor.isActive("superscript") ? "is-active" : ""}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="m4.266 12.496.96-2.853H8.76l.96 2.853H11L7.62 3H6.38L3 12.496h1.266Zm2.748-8.063 1.419 4.23h-2.88l1.426-4.23h.035Zm5.132-1.797v-.075c0-.332.234-.618.619-.618.354 0 .618.256.618.58 0 .362-.271.649-.52.898l-1.788 1.832V6h3.59v-.958h-1.923v-.045l.973-1.04c.415-.438.867-.845.867-1.547 0-.8-.701-1.41-1.787-1.41C11.565 1 11 1.8 11 2.576v.06h1.146Z"/></svg></button>
      ...
      {#if includeTools(["highlighter", "color"])}
        <div class="editor-btn-group {containerClass}">
          {#if includeTools("color")}
            <button tabindex="0" type="button" class={twMerge(btnClass(), "relative")}  on:click={openColorPicker}>
          ...
          {#if includeTools("highlighter")}
            <Dropdown animation="fade" size="custom" style="--dropdown-width: 116px">
              ...
              <div class="flex flex-row flex-wrap gap-1 justify-start dropdown-action-btn highlighter-btn px-1">
                ...
                <button tabindex="0" type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #ffc078" on:click={() => editor.chain().focus().toggleHighlight({color: "#ffc078"}).run()} class:active={editor.isActive("highlight", {color: "#ffc078"}) ? "is-active" : ""}></button>
                <button tabindex="0" type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #e59400" on:click={() => editor.chain().focus().toggleHighlight({color: "#e59400"}).run()} class:active={editor.isActive("highlight", {color: "#e59400"}) ? "is-active" : ""}></button>
                <button tabindex="0" type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #ff7b7b" on:click={() => editor.chain().focus().toggleHighlight({color: "#ff7b7b"}).run()} class:active={editor.isActive("highlight", {color: "#ff7b7b"}) ? "is-active" : ""}></button>
                <button tabindex="0" type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #fa2f55" on:click={() => editor.chain().focus().toggleHighlight({color: "#f72f35"}).run()} class:active={editor.isActive("highlight", {color: "#f72f35"}) ? "is-active" : ""}></button>
                <button tabindex="0" type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #d896ff" on:click={() => editor.chain().focus().toggleHighlight({color: "#d896ff"}).run()} class:active={editor.isActive("highlight", {color: "#d896ff"}) ? "is-active" : ""}></button>
                <button tabindex="0" type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #800080" on:click={() => editor.chain().focus().toggleHighlight({color: "#800080"}).run()} class:active={editor.isActive("highlight", {color: "#800080"}) ? "is-active" : ""}></button>
                <button tabindex="0" type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #39ff14" on:click={() => editor.chain().focus().toggleHighlight({color: "#39ff14"}).run()} class:active={editor.isActive("highlight", {color: "#39ff14"}) ? "is-active" : ""}></button>
                <button tabindex="0" type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #00A033" on:click={() => editor.chain().focus().toggleHighlight({color: "#00A033"}).run()} class:active={editor.isActive("highlight", {color: "#00A033"}) ? "is-active" : ""}></button>
                <button tabindex="0" type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #66b2b2" on:click={() => editor.chain().focus().toggleHighlight({color: "#66b2b2"}).run()} class:active={editor.isActive("highlight", {color: "#66b2b2"}) ? "is-active" : ""}></button>
                <button tabindex="0" type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #008080" on:click={() => editor.chain().focus().toggleHighlight({color: "#008080"}).run()} class:active={editor.isActive("highlight", {color: "#008080"}) ? "is-active" : ""}></button>
                <button tabindex="0" type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #30c5ff" on:click={() => editor.chain().focus().toggleHighlight({color: "#30c5ff"}).run()} class:active={editor.isActive("highlight", {color: "#30c5ff"}) ? "is-active" : ""}></button>
                <button tabindex="0" type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #1919ff" on:click={() => editor.chain().focus().toggleHighlight({color: "#1919ff"}).run()} class:active={editor.isActive("highlight", {color: "#1919ff"}) ? "is-active" : ""}></button>
                <button tabindex="0" type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #79e9de" on:click={() => editor.chain().focus().toggleHighlight({color: "#79e9de"}).run()} class:active={editor.isActive("highlight", {color: "#79e9de"}) ? "is-active" : ""}></button>
                <button tabindex="0" type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #33b3a6" on:click={() => editor.chain().focus().toggleHighlight({color: "#33b3a6"}).run()} class:active={editor.isActive("highlight", {color: "#33b3a6"}) ? "is-active" : ""}></button>
              </div>
            </Dropdown>
          {/if}
        </div>
