<script lang="ts">
  ...
  import { FORM_CTX, Label, Dropdown } from "$lib";
  ...
  let includeTools = (toolsToCheck: Array<Tools> | Tools = []) => {
    ...
    // const toolsToCheckArray = Array.isArray(toolsToCheck) ? toolsToCheck : [toolsToCheck];
    // for (let i = 0; i < toolsToCheckArray.length; i++) {
    //   let toolToCheck = toolsToCheckArray[i] as Tools;
    //   if (tools.includes(toolToCheck) && exclude.includes(toolToCheck)) {
    //     return false;
    //   }
    // }
...
<div class={getInputBoxClasses(C)}>
  {#if editor}
    ...
    <div class="flex flex-wrap editor-toolbar gap-1">
      ...
      <Dropdown animation="fade" size="custom" style="--dropdown-width: 148px">
          ...
          {#if includeTools("highlighter")}
            <Dropdown animation="fade" size="custom" style="--dropdown-width: 116px" >
              ...
              <div class="flex flex-row flex-wrap gap-1 justify-start dropdown-action-btn highlighter-btn px-1">
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #fbf719" on:click={() => editor.chain().focus().toggleHighlight({color: "#fbf719"}).run()} class:active={editor.isActive("highlight", {color: "#fbf719"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #dab600" on:click={() => editor.chain().focus().toggleHighlight({color: "#dab600"}).run()} class:active={editor.isActive("highlight", {color: "#dab600"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #ffc078" on:click={() => editor.chain().focus().toggleHighlight({color: "#ffc078"}).run()} class:active={editor.isActive("highlight", {color: "#ffc078"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #e59400" on:click={() => editor.chain().focus().toggleHighlight({color: "#e59400"}).run()} class:active={editor.isActive("highlight", {color: "#e59400"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #ff7b7b" on:click={() => editor.chain().focus().toggleHighlight({color: "#ff7b7b"}).run()} class:active={editor.isActive("highlight", {color: "#ff7b7b"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #fa2f55" on:click={() => editor.chain().focus().toggleHighlight({color: "#f72f35"}).run()} class:active={editor.isActive("highlight", {color: "#f72f35"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #d896ff" on:click={() => editor.chain().focus().toggleHighlight({color: "#d896ff"}).run()} class:active={editor.isActive("highlight", {color: "#d896ff"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #800080" on:click={() => editor.chain().focus().toggleHighlight({color: "#800080"}).run()} class:active={editor.isActive("highlight", {color: "#800080"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #39ff14" on:click={() => editor.chain().focus().toggleHighlight({color: "#39ff14"}).run()} class:active={editor.isActive("highlight", {color: "#39ff14"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #00A033" on:click={() => editor.chain().focus().toggleHighlight({color: "#00A033"}).run()} class:active={editor.isActive("highlight", {color: "#00A033"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #66b2b2" on:click={() => editor.chain().focus().toggleHighlight({color: "#66b2b2"}).run()} class:active={editor.isActive("highlight", {color: "#66b2b2"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #008080" on:click={() => editor.chain().focus().toggleHighlight({color: "#008080"}).run()} class:active={editor.isActive("highlight", {color: "#008080"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #30c5ff" on:click={() => editor.chain().focus().toggleHighlight({color: "#30c5ff"}).run()} class:active={editor.isActive("highlight", {color: "#30c5ff"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #1919ff" on:click={() => editor.chain().focus().toggleHighlight({color: "#1919ff"}).run()} class:active={editor.isActive("highlight", {color: "#1919ff"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #79e9de" on:click={() => editor.chain().focus().toggleHighlight({color: "#79e9de"}).run()} class:active={editor.isActive("highlight", {color: "#79e9de"}) ? "is-active" : ""}></button>
                <button type="button" class={twMerge(btnClass(), "bg-[var(--bg-color)] dark:bg-[var(--bg-color)] rounded p-0")} style="--bg-color: #33b3a6" on:click={() => editor.chain().focus().toggleHighlight({color: "#33b3a6"}).run()} class:active={editor.isActive("highlight", {color: "#33b3a6"}) ? "is-active" : ""}></button>
              </div>
            </Dropdown>
          {/if}
        </div>
  ...
  <div id="editor" class={getInputClasses(C, $$restProps, 'input', $$props?.class)} bind:this={element} />
