...
<Button on:click={()=>toggle()} class="nav-toggle {twMerge("bg-transparent", $$props.class)} {config.responsive == "xl" ? "2xl:hidden" : config.responsive == "md" ? "lg:hidden" : config.responsive == "lg" ? "xl:hidden" : "hidden"}" ariaLabel="Toggle nav bar" label="">
